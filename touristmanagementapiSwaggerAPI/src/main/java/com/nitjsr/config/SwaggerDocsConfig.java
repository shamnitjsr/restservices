...
public class SwaggerDocsConfig {
	...
	public Docket createDocket() {
		...
		return new Docket(DocumentationType.SWAGGER_2) //UI Screen type
				...
				.apis(RequestHandlerSelectors.basePackage("com.nitjsr.controller")) //base pkg for RestController
	...
	private ApiInfo getApiInfo() {
		Contact contact = new Contact("Shambhu","http://www.shambhu.com/tourist","shamnitjsr@gmail.com");
		return new ApiInfo("Tourist API",
				"Gives Info Tourist Activities",
				"3.4.RELEASE", 
				"http://www.shambhu.com/license", 
				contact, 
				"GNU Public", 
